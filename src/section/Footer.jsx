...
'Delhi to Goa Flight ',
  ...
  return (
    <div className='bg-[#333333]  w-full py-[10px] px-[2.5rem] flex flex-col relative bottom-0 overflow-x-hidden '>
        ...
        <div className='grid grid-cols-3 sm:grid-cols-4 gap-5 text-[#606060]'>
            {
                links.map((e) => {
                    return (<h2 className='hover:text-[#971e1c] text-[0.5rem] sm:text-[1rem]  '>{e}</h2>)
                })
            }
        </div>
        ...
        <div className='Link-page flex flex-col md:flex-row justify-evenly'>
            <div className='flex flex-col'>
                ...
                <p className='hover:text-[#971e1c] text-[0.5rem] sm:text-[1rem]  text-[#606060] px-[0.5rem] mb-[1.5rem]'>Save with our latest fares and offers</p>
            ...
            <div className='flex flex-col'>
                ...
                <p className='hover:text-[#971e1c] text-[0.5rem] sm:text-[1rem]  text-[#606060] px-[0.5rem] mb-[1.5rem]'>Books and manage your flights on the go</p>
            ...
            <div className='flex flex-col'>
                ...
                <p className='hover:text-[#971e1c] text-[0.5rem] sm:text-[1rem]  text-[#606060] px-[0.5rem] mb-[1.5rem]'>Share your Emirates expierence</p>
